(function(window, document) {
                    ...
                    post: function(scope, element, attrs, ngModel) {
                        ...
                        var uploadFile = function(scope) {
                            ...
                            S3Uploader.getUploadOptions(opts.getOptionsUri).then(function(s3Options) {
                                ...
                                var s3Uri = 'https://s3-ap-southeast-1.amazonaws.com/' + bucket + "/";
    ...
    angular.module('ngS3upload').run(['$templateCache', function($templateCache) {
        ...
        $templateCache.put('theme/bootstrap2.html',
            ...
            "  <button class=\"btn btn-primary\" ng-click=\"Clear();\" type=\"button\"><span >Choose file</span></button>\n" +
            "  <a ng-href=\"{{filename}}\" target=\"_blank\" id=\"myFileName\" class=\"\" ng-if=\"filename\" style=\"display:none;\"> Stored file </a>\n" +
            "  <div class=\" progress-striped\" ng-class=\"{active: uploading}\" ng-show=\"attempt\" style=\"margin-top: 10px\">\n" +
            "    <div class=\"progress bar\" style=\"width: {{ progress }}%; background-color:#7bb5ea;\" ng-class=\"barClass()\"></div>\n" +
            "    </div>\n" +
            "  <input type=\"file\" style=\"display: none\"/>\n" +
            " <p id=\'ErrMessage\' style=\"color:red; font-weight:bold;\">{{message}}</p>\n" +
            "</div>"
        );
