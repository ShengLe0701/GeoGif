            ...
            renderPage = function(pagination) {
                pdfDoc.getPage(pagination.currentPage()).then(function(page) {
                    var viewport = page.getViewport(parseInt(scope.scale, 10) || 1, 0),
                        renderContext = {},
                        targetViewport = new RenderViewport(scope.maxHeight || viewport.height, scope.maxWidth || viewport.width);
    ...
    function VideoRenderer(scope, container, canvas) {
        this.render = function() {
            ...
            video.addEventListener("canplay", function() {
                ...
                new RenderViewport(scope.maxHeight, scope.maxWidth).adjustCanvasDimensions(scope.maxHeight, scope.maxWidth, canvas);
                scope.$apply(function() {
